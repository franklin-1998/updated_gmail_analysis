from doc2vec import convertDoc2Vec
import pandas as pd
...
from_value_check = pd.DataFrame(convertDoc2Vec(model_path,data_frame_check['From']))
to_value_check = pd.DataFrame(convertDoc2Vec(model_path,data_frame_check['To']))
subject_value_check = pd.DataFrame(convertDoc2Vec(model_path,data_frame_check['Subject']))
body_value_check = pd.DataFrame(convertDoc2Vec(model_path,data_frame_check['Body']))
